...
public class ArduinoGeneratorException
extends Exception {
    ...
    public static ArduinoGeneratorException UnhandledType(Type t) {
        ArduinoGeneratorException ex = new ArduinoGeneratorException(t.toString());
        return ex;
    }

    public static ArduinoGeneratorException UnhandledTerm(Term t) {
        ArduinoGeneratorException ex = new ArduinoGeneratorException(t.toString() + " : " + t.getClass().toString());
        return ex;
    }
    ...
    public static ArduinoGeneratorException UnclosedEntity(Entity entity) {
        ArduinoGeneratorException ex = new ArduinoGeneratorException(String.format("Entity %s is not closed.", entity.getName()));
        return ex;
    }

    public static ArduinoGeneratorException InconsistentPinType(int pinIndex) {
        ArduinoGeneratorException ex = new ArduinoGeneratorException(String.format("directions of pin %d are inconsistent.", pinIndex));
        return ex;
    }
}
