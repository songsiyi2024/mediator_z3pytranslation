...
public class GloballyStateFormulae
implements StateFormulae {
    ...
    public GloballyStateFormulae fromContext(ParserRuleContext context, RawElement parent) throws ValidationException {
        ...
        this.setFormula(StateFormulae.parse(((MediatorLangParser.GloballyStateFormulaeContext)context).stateFormulae(), (RawElement)this));
        return this;
    }
    ...
    public String toString() {
        return "G " + this.formula.toString();
    }

    @Override
    public Term copy(RawElement parent) throws ValidationException {
        GloballyStateFormulae copy = new GloballyStateFormulae();
